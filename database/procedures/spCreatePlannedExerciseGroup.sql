...
BEGIN
    ...
    INSERT INTO PlannedExerciseGroup (workout_routine_id, group_index, rest_between, rest_after)
    VALUES (p_workout_routine_id, p_group_index, p_rest_between, p_rest_after);
