...
export function ContactEditCreateForm(props: ContactEditCreateFormProps) {
	...
	return (
		<div
			id="contact-edit-create-form-container"
			style={{
				display: 'flex',
		...
		>
			...
			>
				<Form.Item
					...
					required
					name="firstName"
					validateStatus={validationStatuses.firstName?.validateStatus}
					help={validationStatuses.firstName?.help}
				>
				...
				<Form.Item
					...
					required
					name="lastName"
					validateStatus={validationStatuses.lastName?.validateStatus}
					help={validationStatuses.lastName?.help}
				>
				...
				<Form.Item
					...
					required
					name="email"
					validateStatus={validationStatuses.email?.validateStatus}
					help={validationStatuses.email?.help}
				>
