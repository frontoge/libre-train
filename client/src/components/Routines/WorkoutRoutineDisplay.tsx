...
import {
	collectAllTreeKeys,
	deleteNodesByKeys,
	getWorkoutRoutineTreeData,
	handleRoutineDrop,
	mapRoutineTreeToRoutineGroups,
} from '../../helpers/routine-helpers';
import {
	WorkoutNodeType,
...
export function WorkoutRoutineDisplay(props: WorkoutRoutineProps) {
	...
	return (
		<Card
			title={
				updatingTitle ? (
					<Input defaultValue={routine.routine_name} autoFocus onBlur={handleTitleChange} />
				) : (
		...
		>
			...
			>
				<Button color="default" variant="filled" onClick={clearSelection}>
					Clear Selection
				</Button>
