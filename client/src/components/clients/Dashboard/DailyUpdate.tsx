			...
			>
				...
				>
					...
					>
						<Calendar
							fullscreen={false}
							value={dashboardState.selectedDate}
							onSelect={(date) => setDashboardState((prev) => ({ ...prev, selectedDate: date }))}
						/>
					</div>
					<div
						style={{
					...
					>
						...
						>
							<InputNumber
								...
								onChange={(val) => setDailyData({ ...dailyData, weight: undefinedIfNull(val) })}
							/>
							<InputNumber
								...
								max={100}
								suffix={'%'}
								value={dailyData.body_fat}
								onChange={(val) => setDailyData({ ...dailyData, body_fat: undefinedIfNull(val) })}
							/>
							<InputNumber
								...
								onChange={(val) => setDailyData({ ...dailyData, calories: undefinedIfNull(val) })}
							/>
							<InputNumber
								...
								min={0}
								suffix={'kcal'}
								value={dailyData.target_calories}
								onChange={(val) => setDailyData({ ...dailyData, target_calories: undefinedIfNull(val) })}
							/>
							<InputNumber
								placeholder="Protein"
								style={{ width: '100%' }}
								...
								onChange={(val) => setDailyData({ ...dailyData, protein: undefinedIfNull(val) })}
							/>
							<InputNumber
								...
								min={0}
								suffix={'g'}
								value={dailyData.target_protein}
								onChange={(val) => setDailyData({ ...dailyData, target_protein: undefinedIfNull(val) })}
							/>
							<InputNumber
								placeholder="Carbs"
								style={{ width: '100%' }}
								...
								onChange={(val) => setDailyData({ ...dailyData, carbs: undefinedIfNull(val) })}
							/>
							<InputNumber
								...
								min={0}
								suffix={'g'}
								value={dailyData.target_carbs}
								onChange={(val) => setDailyData({ ...dailyData, target_carbs: undefinedIfNull(val) })}
							/>
							<InputNumber
								placeholder="Fats"
								style={{ width: '100%' }}
								min={0}
								suffix={'g'}
								value={dailyData.fats}
								onChange={(val) => setDailyData({ ...dailyData, fats: undefinedIfNull(val) })}
							/>
							<InputNumber
								...
								min={0}
								suffix={'g'}
								value={dailyData.target_fats}
								onChange={(val) => setDailyData({ ...dailyData, target_fats: undefinedIfNull(val) })}
							/>
						</div>
					</div>
				</div>
