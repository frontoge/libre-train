...
export function ClientEditCreateForm(props: ClientEditCreateFormProps) {
	...
	return (
		<div
			id="client-edit-create-form-container"
			style={{
				display: 'flex',
		...
		>
			...
			<Form
				...
				onFinish={onFinish}
			>
				<Form.Item label="Client height" name="height" wrapperCol={{ span: 12 }}>
					<InputNumber suffix="in." />
				</Form.Item>
				<Form.Item label="Client notes" name="notes" wrapperCol={{ span: 12 }}>
