import type { OmitAutogeneratedFields, PlannedExercise, PlannedExerciseGroup, WorkoutRoutine } from '@libre-train/shared';
...
export type WorkoutRoutineEdit = Omit<OmitAutogeneratedFields<WorkoutRoutine>, 'routine_index' | 'isActive'>;
...
export type RoutineTreePlannedExercise = PlannedExercise & {
	exerciseName?: string;
};
